...
export class SuiInputSelect implements AfterContentInit, AfterViewInit {
    ...
    private renderedOptions:QueryList<SuiInputSelectOption>;
    ...
    private renderedOptionsSubscribe() {
        ...
        this.renderedOptions.forEach((option:SuiInputSelectOption) => {
...
export const CUSTOM_VALUE_ACCESSOR: any = {
    ...
    useExisting: forwardRef(() => SuiInputSelectValueAccessor),
    multi: true
};
...
export class SuiInputSelectValueAccessor implements ControlValueAccessor {
    onChange = () => {};
    onTouched = () => {};

    constructor(private host:SuiInputSelect) {}
...
export const SUI_INPUT_SELECT_DIRECTIVES = [SuiInputSelect, SuiInputSelectOption, SuiInputSelectValueAccessor];
